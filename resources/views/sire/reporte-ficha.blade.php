...
<head>
    ...
    <style>
        ...
        /* ------------------------------------------------------------------
           ESTILOS DEL PIE DE PÁGINA (NUEVO)
           ------------------------------------------------------------------ */
        footer {
            position: fixed;
            bottom: -1.5cm; /* Lo posicionamos en el espacio del margen inferior */
            left: 0;
            right: 0;
            height: 1cm;
            font-size: 9px;
        ...
        .footer-table td {
            border: none; /* Quitamos bordes para la tabla del footer */
            padding: 0;
        }
        /* Contadores automáticos para la paginación */
        .pagenum:before {
    ...
    <div class="movimiento-box">
        <div class="mov-header">
            ...
            <span style="float: right;">
                <strong>Inscripción:</strong> N° {{ $fila->num_inscripcion }} &nbsp;|&nbsp; 
...
<div class="section-title">RESUMEN DE ACTOS A CERTIFICAR</div>
    ...
    <div class="certification">
        ...
        <p>El suscrito Registrador de la Propiedad del Cantón Morona, certifica que la presente ficha registral, con número <strong>** {{ $ficha }} **</strong>, es fiel copia del original que reposa en los archivos de esta institución. La presente certificación se extiende a los {{ \Carbon\Carbon::now()->format('d \de F \de Y') }}.</p>
    
    <!-- Cuadro de validez -->
    <div style="border: 1px solid #333; padding: 10px; margin: 20px 0; background-color: #f9f9f9; text-align: center;">
        <p style="margin: 0; font-size: 0.9em;">
            <strong>NOTA:</strong> El certificado tiene validez únicamente por 30 días a partir de su emisión.
        </p>
    </div>
